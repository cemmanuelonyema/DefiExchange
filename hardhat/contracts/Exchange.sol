...
contract Exchange is ERC20 {
    ...
    //Exchange is inheriting ERC20, because our exchange keeps track of Crypto Dev lp tokens
...
* So we can just call the balanceOf to 
* check the balance of CryptoDev Tokens that the contract address holds
*/
...
function addLiquidity(uint _amount) public payable returns (uint) {
    ...
    ERC20 CryptoDevToken = ERC20(cryptoDevsTokenAddress);
     /*
        If the reserve is empty, take any user supplied value for
...
*/
function ethToCrytoDevToken(uint _minTokens) public payable{
    ...
    require(tokensBought >= _mintoken, 'Insufficent output amount');
